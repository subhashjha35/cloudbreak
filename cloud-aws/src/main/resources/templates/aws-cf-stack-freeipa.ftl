  ...
  "Resources" : {
    ...
    "${group.autoScalingGroupName}" : {
      ...
      "Properties" : {
        ...
        "LaunchTemplate" : {
          "LaunchTemplateId": { "Ref" : "AmbariNodeLaunchTemplate${group.groupName?replace('_', '')}" },
          "Version": { "Fn::GetAtt": "AmbariNodeLaunchTemplate${group.groupName?replace('_', '')}.LatestVersionNumber" }
        },
    ...
    "AmbariNodeLaunchTemplate${group.groupName?replace('_', '')}"  : {
