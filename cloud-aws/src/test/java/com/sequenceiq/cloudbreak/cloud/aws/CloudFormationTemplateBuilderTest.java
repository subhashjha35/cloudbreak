...
public class CloudFormationTemplateBuilderTest {
    ...
    public void buildTestInstanceGroupsAndRootVolumeSize() throws IOException {
        ...
        Assertions.assertThat(templateString)
                ...
                .matches(template -> template.contains("AmbariNodeLaunchConfigmaster") || template.contains("AmbariNodeLaunchTemplatemaster"))
                .contains("ClusterNodeSecurityGroupmaster")
                .contains("AmbariNodesgateway")
                .matches(template -> template.contains("AmbariNodeLaunchConfiggateway") || template.contains("AmbariNodeLaunchTemplategateway"))
